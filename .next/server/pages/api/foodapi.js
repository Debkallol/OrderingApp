...
/* harmony import */ var _models_Foodnote__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(978);
        ...
        switch(method){
            ...
            case 'POST':
                try {
                    ...
                    const notessave = await _models_Foodnote__WEBPACK_IMPORTED_MODULE_1___default().create(req.body);
                    // const newdata = {
                    //     id: Date.now(),
                    //     text: occasion,
                    //     text: budget,
...
var __webpack_exports__ = __webpack_require__.X(0, [845], () => (__webpack_exec__(589)));
